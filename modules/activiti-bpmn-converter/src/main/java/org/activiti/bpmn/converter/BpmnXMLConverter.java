    ...
    public BpmnModel convertToBpmnModel(XMLStreamReader xtr) {
        ...
        try {
            ...
            while (xtr.hasNext()) {
                ...
                /**
                 * 猜测：
                 * 1. 基本元素使用 Parser，没给 Parser 中都将解析出的元素和 Model 关联
                 * 2. 自定义元素使用 converter 命名
                 */
                // <definitionsxmlns:activiti...></definitionsxmlns>
